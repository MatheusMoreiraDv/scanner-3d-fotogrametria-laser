...
"""
Código de referência estudado a partir do projeto Raspberry Pi Laser Scanner,
usado apenas como baseline histórico para análise e reimplementação didática.

A implementação principal deste repositório será reescrita de forma modular,
documentada e adaptada aos objetivos do TCC/artigo.
"""
